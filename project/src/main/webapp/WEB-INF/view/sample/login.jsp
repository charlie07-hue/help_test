...
<head>
    ...
    <title>로그인</title>
    <%//@ include file ="/WEB-INF/view/include/head.jsp" %> <!-- 디렉티브 방식 | head 소스를 그대로 가져옴 / 위에 변수선언한것 사용 可-->
    <jsp:include page="/WEB-INF/view/include/head.jsp"/> <!-- 액션태그 방식 | head.jsp를 실행한 결과를 가져옴 / 위에 변수선언한것 사용 不可 -->
    <c:import url="/WEB-INF/view/include/head.jsp"/> <!-- 실행 후 결과를 가져옴 -->
</head>
<body>
    <div class="wrap">
