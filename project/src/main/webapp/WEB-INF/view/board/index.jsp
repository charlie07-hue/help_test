                    ...
                    <p><span><strong>총 ${boardVo.totCount }개</strong>  |  ${boardVo.reqPage}/${boardVo.totPage }페이지</span></p>
                        ...
                        <c:forEach var="vo" items="${list }">     
                            <tr>
                                <td>${vo.no }</td>
                                <td class="txt_l">
                                    <a href="detail.do?no=${vo.no }&reqPage=${boardVo.reqPage }&stype=${param.stype}&sval=${param.sval}&orderby=${param.orderby}&direct=${param.direct}">${vo.title }</a> <!-- WHERE절의 조건으로 要 -->
                                </td>
                                <td class="writer">
                                    홍길동
                                </td>
